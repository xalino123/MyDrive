	...
	<div id="groupsList">
		<form action="VisInviti.jsp" method="post">
	        ...
	        <div class="form-group">
	        	Nome gruppo: <%= groupName %> Ruolo: <%=user.getInviti().get(groupName)%>
	        	<button type="submit" class="promoteButton" name="accept" value="<%=groupName%>">Accetta</button>
	        	<button type="submit" class="removeUserButton" name="refuse" value="<%=groupName%>">Rifiuta</button>
	        </div>
